...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50/30 to-indigo-50/40 flex flex-col justify-between font-sans text-slate-800 relative overflow-hidden selection:bg-sky-200 selection:text-sky-900">
      ...
      {/* Main Content Area */}
      <main className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 my-auto space-y-10">
        
        {/* TOP SECTION: PRIMARY AUTHENTICATION CARD */}
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white/95 backdrop-blur-2xl border border-slate-200/90 shadow-[0_25px_60px_-15px_rgba(2,132,199,0.14)] rounded-3xl p-6 sm:p-9 space-y-6 transition-all">
            ...
            <div className="text-center space-y-2">
              <div className="w-13 h-13 w-12 h-12 rounded-2xl bg-gradient-to-tr from-sky-500 to-indigo-600 p-2.5 flex items-center justify-center shadow-md shadow-sky-500/20 mx-auto mb-3">
        ...
        {/* BELOW SECTION: ENTERPRISE CAPABILITIES & TRUST HIGHLIGHTS */}
        <div className="pt-4 border-t border-slate-200/60">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            
            {/* Card 1 */}
            <div className="p-4.5 rounded-2xl bg-white/80 border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex items-start gap-3 text-left">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[11px] text-slate-500 leading-relaxed">
                  Automated Indian EPF (12%), ESI (0.75%), Professional Tax, and TDS calculations.
                </p>
              </div>
            </div>
            ...
            <div className="p-4.5 rounded-2xl bg-white/80 border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex items-start gap-3 text-left">
              ...
              <div className="space-y-0.5">
                <h3 className="text-xs font-bold text-slate-900">
                  Digitally-Sealed Payslips
                </h3>
                <p className="text-[11px] text-slate-500 leading-relaxed">
                  Encrypted salary archives with employee PAN verification and one-click PDF generation.
                </p>
              </div>
            </div>
            ...
            <div className="p-4.5 rounded-2xl bg-white/80 border border-slate-200/80 shadow-xs hover:shadow-md transition-all flex items-start gap-3 text-left">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[11px] text-slate-500 leading-relaxed">
                  Web check-in/out, leave requests, shift regularizations, and reimbursement claims.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Quick Badges */}
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs text-slate-500 font-medium pt-5">
      ...
      <footer className="relative z-20 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5 text-center space-y-2">
