    ...
    <aside className="w-64 h-screen bg-slate-900 text-slate-300 flex flex-col border-r border-slate-800 select-none">
      ...
      <div className="p-3 border-t border-slate-800/80 bg-slate-950/70 space-y-2">
        ...
        >
          ...
          <option value="hr_admin">💼 HR Admin (Meera)</option>
          <option value="payroll_manager">📊 Payroll Mgr (Rahul)</option>
          <option value="manager">👔 Manager (Aarav)</option>
          <option value="employee">👩‍💻 Employee (Diya)</option>
        </select>
        {isDemoMode && (
